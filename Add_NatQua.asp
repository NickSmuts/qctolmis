...
Sub DisplayForm()
	...
	html = html & "<font face=Verdana>Please add National Qualification Name and Number then press the Update button.</font><p>"
	html = html & "<font color=red>" & sError & "</font><p>"
	html = html & "<form name=form1 method=Post action=Add_NatQua.asp>"
	html = html & "<table cellpadding=2 cellspacing=2>"
	html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>National Qualification Name:</font></td><td><input size=20 name=Nqname value=" & Chr(34) & Nqname & Chr(34) & "></td></tr>"
	html = html & "</table><p>"
...
Set objRS = objDB.Execute("select * from NatQua")
If objRS.EOF Then
...
Response.Write("<tr>")
Response.Write("<td><B><font face=Verdana>National Qualifications fields</font></B></td>")
Response.Write("</tr>")
Do While Not objRS.EOF
	Response.Write("<tr bgcolor=" & sRowColor & ">")
	Response.Write("<td><font face=Verdana>" & objRS("Nqname") & "</font></td>")
	Response.Write("</tr>")
	objRS.MoveNext
Loop
...
Sub ValidateData()
	Nqname = Trim(Request.Form("Nqname"))



	If Nqname = "" Then
		sError = sError & "Nqname is a required field.<br>"
	End If 
	...
	Else
		...
		sql = "Insert Into NatQua ("
		sql = sql & "Nqname"
		sql = sql & ") "
		sql = sql & "Values ("
		sql = sql & "'" & SqlQuote(Nqname) & "'"
		sql = sql & ");"
