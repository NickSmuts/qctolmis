...
Sub DisplayForm()
	...
	html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>OFO Code:</font></td>"	
	    ...
	    Html = html & "<td><select  name=OFOCode>"
    	...
    	Html = html & "</select></td></tr>"
			...
			If len(OFOCode) > 1 Then

strSQL = "SELECT  * FROM OFOCode where OFOCode='" & OFOCode &"'"
objRS6.Open strSQL, objDB

Do While Not objRS6.EOF 
	'Response.Write objRS6("id") & " " & objRS6("OFODesc") & "  "  & objRS6("OFOCode") & "<br>"
	 	html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>OFO Description:</font></td><td><input size=35 name=OFO_Desc id=OFO_Desc value=" & Chr(34) & objRS6("OFODesc") & Chr(34) &"  readonly></input size=35></td></tr>"
     objRS6.MoveNext
 Loop
 Html = html & "</select></td></tr>"
	...
	'html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>OFO Description:</font></td><td><input size=35 name=OFO_Desc value=" & Chr(34) & OFODesc & Chr(34) &"  readonly></input size=35></td></tr>"
    ...
    Html = html & "<td><select  name=Project>"
   	...
   	html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>Company Name:</font></td>"	
	    ...
	    Html = html & "<td><select  name=CompanyName>"
			Do While Not objRS7.EOF
			html = html & "<option "
			If Project = (objRS7("CompanyName")) then
   			html = html & "selected "
  			end if
			Html = html &"value=" & Chr(34) & objRS7("CompanyName") & Chr(34) & ">" &objRS7("CompanyName")
		...
		html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>Training Manager:</font></td><td><input size=35 name=TrainingManager value=" & Chr(34) & TrainingManager & Chr(34) &"  readonly></td></tr>"	

		html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>Contact Number:</font></td><td><input size=35 name=CNumber value=" & Chr(34) & CNumber & Chr(34) &"  readonly></td></tr>"	
		html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>SICCode:</font></td><td><input size=35 name=SICCode value=" & Chr(34) & SICCode & Chr(34) &"  readonly></td></tr>"	
		html = html & "<tr bgcolor=" & sRowColor &"><td><font face=Verdana>SSUCode:</font></td><td><input size=35 name=SSUCode value=" & Chr(34) & SSUCode & Chr(34) &"  readonly></td></tr>"		
